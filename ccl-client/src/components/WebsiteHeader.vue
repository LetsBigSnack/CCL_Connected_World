    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1">
      <div class="flex gap-8">
        <router-link to="/" class="flex items-center">
          ...
          <span class="self-center text-3xl whitespace-nowrap dark:text-white font-display">BattleChamp</span>
        </router-link>
      </div>
      <div class="w-full m-4 md:w-auto flex flex-wrap items-center justify-center gap-8 text-md md:text-xl">
        <div class="items-center justify-between hidden w-full md:flex md:w-auto" id="mobile-menu-2">
          <ul class="flex flex-col gap-2 md:gap-0 font-medium justify-center items-center p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0">
            <li>
              <router-link to="/" class="hover:text-primary_bcc block py-2 pl-3 pr-4 text-white rounded hover:bg-tertiary_bcc md:hover:bg-transparent md:hover:text-primary_bcc md:p-0">Home</router-link>
            </li>
            <li>
              <router-link to="/shop" class="hover:text-primary_bcc block py-2 pl-3 pr-4 rounded hover:bg-tertiary_bcc md:hover:bg-transparent md:hover:text-primary_bcc md:p-0">Shop</router-link>
            </li>
            <li>
        ...
        <!-- Dropdown menu -->
        <button data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 text-sm rounded-lg md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
